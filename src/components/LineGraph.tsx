...
export function LineGraph({
  ...
  return (
    ...
    <div className="flex items-center mb-4">
        <label className="text-gray-700 text-sm font-semibold mr-2">Data Labels (enter labels separated by commas)</label>
        <input type="text" id="dataLabels" className="flex-1 px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500" defaultValue="a, b, c, d, e"/>
    </div>

    <div className="flex items-center mb-4">
        <label className="text-gray-700 text-sm font-semibold mr-2">Data Values (enter values separated by commas)</label>
        <input type="text" id="dataValues" className="flex-1 px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500" defaultValue="10, 50, 20, 100, 150"/>
    </div>

    <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-4">
        <div className="flex items-center">
            <label className="text-gray-700 text-sm font-semibold mr-2">Line Tension (0 to 1)</label>
            <input type="number" id="lineTension" min="0" max="1" step="0.1" className="flex-1 px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500" defaultValue="0"/>
        </div>
        <div className="flex items-center">
        ...
        <div className="flex items-center">
            <label className="text-gray-700 text-sm font-semibold mr-2">Legend Align</label>
            <select id="legendAlign" className="flex-1 px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500">
    ...
    <div className="space-y-2 mb-4">
        <div className="flex items-center">
            <input type="checkbox" id="startFromZero" className="w-4 h-4 text-blue-600" checked/>
        ...
        <div className="flex items-center">
            <input type="checkbox" id="showYGrid" className="w-4 h-4 text-blue-600" checked/>
            <label className="ml-2 text-gray-700">Show Y axis grid lines</label>
        </div>
        <div className="flex items-center">
            <input type="checkbox" id="showPoints" className="w-4 h-4 text-blue-600" checked/>
            <label className="ml-2 text-gray-700">Show Points</label>
        </div>
    </div>

    <div className="flex items-center mb-4">
        <label className="text-gray-700 text-sm font-semibold mr-2">Select Line Color:</label>
        <input type="color" id="lineColor" className="flex-1 h-10 w-20"/>
    </div>
