...
export default async function HandPage({ params: { lang } }: { params: { lang: Locale } }) {
  ...
  return (
    ...
    <iframe src={lang === 'en' ? '/html/Segmented-Bar-Graph-Maker.html' : '/html/Segmented-Bar-Graph-Maker-CN.html'} allow="autoplay"  style={{ top: '0px', left: '0px',width: '100%', height: '1250px'}}></iframe>
